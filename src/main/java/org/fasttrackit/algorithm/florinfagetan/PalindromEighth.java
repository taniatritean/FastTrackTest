...
public class PalindromEighth {
    public static void main(String[] args) {
        ...
        if (altNrDepozit==nrInvers){
            System.out.println("numarul "+nrInvers+ " este palindrom");
        }else {
            System.out.println("numarul "+nrInvers+ " nu este palindrom");
        }
